...
{
    options.RequireHttpsMetadata = false; // Dla developmentu - pozw�l na HTTP
...
builder.Services.Configure<IpRateLimitOptions>(options =>
{
    ...
    {
        // Globalny limit dla wszystkich endpointów
        new RateLimitRule
        {
            Endpoint = "*",
            Period = "1m",
            Limit = 100 // 100 zapytań na minutę per IP
        },
...
// Global Exception Handling Middleware - musi by� na pocz�tku pipeline
...
//Utworzenie przyk�adowych danych, je�li baza jest pusta z klasy SeedData
